	...
	WebClient sessionWebclient;
		...
		ExpEditor expEditor = (ExpEditor) session.getAttribute("expeditor");
			...
			if(request.getParameter("id") != null){
				...
				int resultStatus = sessionWebclient.changeExperiment(id, "-1", description, status);
				if(resultStatus == 204){	
					...
					var url ="/WebEditor/view/Experiment/"+id;
					location.href=url;
...
%>
	...
	<h3><fmt:message key="Experiment"/>:</h3><br>
	...
	<input type="checkbox" name="status" id="status" value="active" style="vertical-align:middle"><fmt:message key="active"/><br><br>
